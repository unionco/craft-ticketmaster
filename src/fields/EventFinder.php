...
use unionco\ticketmaster\assetbundles\eventfinderfield\EventFinderFieldAsset;
 ...
 * @since     1.0.0
 */
class EventFinder extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('ticketmaster', 'EventFinder');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'ticketmaster/_components/fields/EventFinder_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(EventFinderFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').TicketmasterEventFinder(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'ticketmaster/_components/fields/EventFinder_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
